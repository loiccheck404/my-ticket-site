          ...
          <tr>
            <td style="padding: 30px;">
              ...
              <table width="100%" style="margin: 30px 0; background-color: #000; border: 1px solid #FFD700; border-radius: 8px;">
                <tr>
                  <td style="padding: 20px;">
                    ...
                    <p style="color: #fff; font-size: 20px; margin: 0; font-family: monospace;">#${data.orderId.slice(
                      0,
                      8
                    )}...</p>
                  </td>
                  <td style="padding: 20px; text-align: right;">
                    ...
                    <p style="color: #fff; font-size: 28px; margin: 0; font-weight: bold;">$${
                      data.totalAmount
                    }</p>
                  </td>
                </tr>
              ...
              <table width="100%" style="margin: 30px 0;">
                <tr>
                  <td align="center">
                    <a href="http://localhost:5000/api/tickets/download/${
                      data.orderId
                    }" 
              ...
              <p style="color: #888; font-size: 14px; margin: 30px 0 0;">
                Payment Method: <strong style="color: #FFD700;">${
                  data.paymentMethod
                }</strong>
              </p>
            </td>
