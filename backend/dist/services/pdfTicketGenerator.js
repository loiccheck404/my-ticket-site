...
exports.PDFTicketGenerator = void 0;
...
class PDFTicketGenerator {
    ...
    async generateTicket(ticketData) {
        ...
        const statusColor = ticketData.status === "CONFIRMED" ? "#22c55e" : "#eab308";
        ...
        doc
            ...
            .fillColor("#ffffff")
            .font("Helvetica")
            .text("• Please arrive 30 minutes before the match starts\n" +
            "• Present this ticket and valid ID at the entrance\n" +
            "• Ticket is non-transferable and non-refundable\n" +
            "• Scan QR code at entry gates for verification", 50, footerY + 35, { width: 500 });
        return doc;
    }
    /**
...
exports.PDFTicketGenerator = PDFTicketGenerator;
